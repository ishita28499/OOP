...
appLabel.config(font=("black", 30))
appLabel.grid(row=0, columnspan=2, padx=(500,10), pady=(30, 0))

bottomLabel = tk.Label(root,text="Designed and Developer by Shubham Nigam and Ansh Gupta",fg="black",width=50)
bottomLabel.config(font=("black",15))
bottomLabel.grid(row=20,columnspan=10, padx=(600,100), pady=(350, 100))
...
nameEntry = tk.Entry(root, width = 50)
collegeEntry = tk.Entry(root, width = 50)
phoneEntry = tk.Entry(root, width = 50)
addressEntry = tk.Entry(root, width = 50)
